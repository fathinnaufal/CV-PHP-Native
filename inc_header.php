...
<head>
    ...
    <title>Harry Agustanto S.H.,M.H.</title>
    <link rel="stylesheet" href="<?php echo url_dasar()?>/css/style.css">
</head>
<body>
    <nav>
        <div class="wrapper">
            <div class="logo"><a href='<?php echo url_dasar()?>'>Harry Agustanto S.H.,M.H.</a></div>
            <div class="menu">
                <ul>
                    <li><a href="<?php echo url_dasar()?>#home">Home</a></li>
                    <li><a href="<?php echo url_dasar()?>#courses">Karir</a></li>
                    <li><a href="<?php echo url_dasar()?>#tutors">Sertifikasi</a></li>
                    <li><a href="<?php echo url_dasar()?>#partners">Knowledge</a></li>
